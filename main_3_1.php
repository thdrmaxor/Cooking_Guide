...
<hr></hr>
   ...
   <!-- 레시피검색 메인페이지 -->
    ...
    <body>
        <h2>원하는 레시피를 검색하세요!</h2>
        <div class="search-form-container">
            <form id="keywordForm" method="post" action="">
                <div class="input-row">
                   <input class="input-field" type="search" id="keyword" name="keyword"  placeholder="이곳에 원하는 레시피 검색">
                </div>
        ...
        <?php
            if (isset($_POST['submit']) )
            {
              ...
              if (!empty($keyword))
              {
                $apikey = 'AIzaSyByjMB_NGgWdYj-HVQCzdpB9MV0dW8WIQ0'; 
